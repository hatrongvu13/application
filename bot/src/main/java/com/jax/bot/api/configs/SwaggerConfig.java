package com.jax.bot.api.configs;
...
//	private String host;
    ...
    @Bean
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false).apiInfo(getApiInfo()).select().apis(RequestHandlerSelectors.basePackage("com.jax.bot.api.controllers"))
