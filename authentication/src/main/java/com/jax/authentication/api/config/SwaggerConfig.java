package com.jax.authentication.api.config;
...
//	private String host;
    ...
    private ApiInfo getApiInfo() {
        Contact contact = new Contact("Jax", "jaxtony.xyz", "monsterjax13@gmail.com");
        return new ApiInfoBuilder().title("Spring Boot Swagger").description("jax tony").version("1.0.0")
